...
call s:h("TabLine", { "fg": s:comment_grey, "bg": s:menu_grey }) " tab pages line, not active tab page label
call s:h("TabLineFill", { "fg": s:white }) " tab pages line, where there are no labels
call s:h("TabLineSel", { "fg": s:cyan }) " tab pages line, active tab page label
